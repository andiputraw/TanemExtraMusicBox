...
namespace TanemExtraMusicBox.Content.Items.MusicBox.NetzachBattle1
{
	public class NetzachBattle1 : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Netzach Battle 1"), ModContent.ItemType<NetzachBattle1>(), ModContent.TileType<NetzachBattle1Tile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<NetzachBattle1Tile>(), 0);
		}
