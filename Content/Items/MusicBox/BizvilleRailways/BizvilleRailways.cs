...
namespace TanemExtraMusicBox.Content.Items.MusicBox.BizvilleRailways
{
	public class BizvilleRailways : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Bizville Railways"), ModContent.ItemType<BizvilleRailways>(), ModContent.TileType<BizvilleRailwaysTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<BizvilleRailwaysTile>(), 0);
		}
