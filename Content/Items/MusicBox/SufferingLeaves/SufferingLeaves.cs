...
using TanemExtraMusicBox.Content.Items.Materials;
using Terraria.Graphics.CameraModifiers;
using Terraria.ID;
using Terraria.ModLoader;

namespace TanemExtraMusicBox.Content.Items.MusicBox.SufferingLeaves
{
	public class SufferingLeaves : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SufferingLeaves"), ModContent.ItemType<SufferingLeaves>(), ModContent.TileType<SufferingLeavesTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<SufferingLeavesTile>(), 0);
		}
